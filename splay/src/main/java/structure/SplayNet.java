...
public class SplayNet {
    ...
    private SplayNet.Node splay(SplayNet.Node h, int key) {
    ...
    private SplayNet.Node rotateRight(SplayNet.Node h) {
        SplayNet.Node x = h.left;
        h.left = x.right;
        x.right = h;
        return x;
    }
    ...
    // left rotate
    private SplayNet.Node rotateLeft(SplayNet.Node h) {
        SplayNet.Node x = h.right;
        h.right = x.left;
        x.left = h;
        return x;
    }

    public void printPreorder(SplayNet.Node node) {
        if (node == null)
            return;
